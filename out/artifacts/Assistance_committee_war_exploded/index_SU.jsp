      ...
      <div class="lyear-layout-sidebar-scroll">
        ...
        <nav class="sidebar-main">
          <ul class="nav nav-drawer">
            <li class="nav-item active"> <a href="index_SU.jsp"><i class="mdi mdi-home"></i> 系统首页</a> </li>
            <li class="nav-item nav-item-has-subnav">
              <a href="javascript:void(0)"><i class="mdi mdi-palette"></i> 清单数据操作</a>
              <ul class="nav nav-subnav">
                <li> <a href="researchData_SU.html">查询数据</a> </li>
                <li> <a href="researchData_SU.html">输出数据</a> </li>
              </ul>
            </li>
            <li class="nav-item nav-item-has-subnav">
              <a href="javascript:void(0)"><i class="mdi mdi-format-align-justify"></i> 报告操作</a>
              <ul class="nav nav-subnav">
                <li> <a href="researchReport_SU.html">查询报告</a> </li>
                <li> <a href="researchReport_SU.html">输出报告</a> </li>
              </ul>
            </li>
          </ul>
        </nav>
          ...
          <ul class="topbar-right">
            <li class="dropdown dropdown-profile">
              ...
              <ul class="dropdown-menu dropdown-menu-right">
                <li> <a href="lyear_pages_profile_SU.html"><i class="mdi mdi-account"></i> 个人信息</a> </li>
                <li> <a href="lyear_pages_edit_pwd_SU.html"><i class="mdi mdi-lock-outline"></i> 修改密码</a> </li>
