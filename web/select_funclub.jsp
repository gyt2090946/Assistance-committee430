                            ...
                            <div class="card-body">
                                ...
                                <div class="masonry-grid gap-2" data-provide="photoswipe">
                                    ...
                                    <label class="lyear-checkbox checkbox-primary m-t-10">
                                        ...
                                        <span><img src="images/gallery/2.jpg"></span>
                                    </label>
                                    <label class="lyear-checkbox checkbox-primary m-t-10">
                                        <input type="checkbox">
                                        <span><img src="images/gallery/3.jpg"></span>
                                    </label>
                                    <label class="lyear-checkbox checkbox-primary m-t-10">
                                        <input type="checkbox">
                                        <span><img src="images/gallery/4.jpg"></span>
                                    </label>
                                    <label class="lyear-checkbox checkbox-primary m-t-10">
                                        <input type="checkbox">
                                        <span><img src="images/gallery/5.jpg"></span>
                                    </label>
                                    <label class="lyear-checkbox checkbox-primary m-t-10">
                                        <input type="checkbox">
                                        <span><img src="images/gallery/6.jpg"></span>
                                    </label>
                                    <label class="lyear-checkbox checkbox-primary m-t-10">
                                        <input type="checkbox">
                                        <span><img src="images/gallery/7.jpg"></span>
                                    </label>
                                    <label class="lyear-checkbox checkbox-primary m-t-10">
                                        <input type="checkbox">
                                        <span><img src="images/gallery/8.jpg"></span>
                                    </label>
                                    <label class="lyear-checkbox checkbox-primary m-t-10">
                                        <input type="checkbox">
                                        <span><img src="images/gallery/9.jpg"></span>
                                    </label>
                                </div>
                                <div class="on col-lg-12">
                                    <!--提交页面需要根据用户身份判断-->
                                    <button class="btn btn-block btn-primary" onclick="location.href='index_OU.html'">确认提交</button>
                                </div>
                            </div>
                        </div>
                    </div>
